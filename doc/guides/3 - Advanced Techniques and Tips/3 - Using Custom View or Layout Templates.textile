...
Create +app/views/refinery/pages/<my_view>.html.erb+, where +<my_view>+ is the name of the file you whitelisted.
...
You can also entirely override the +show+ method inside this decorator, too, if need be. You can view the existing method "here for reference":https://github.com/resolve/refinerycms/blob/master/pages/app/controllers/refinery/pages_controller.rb#L23-39.
